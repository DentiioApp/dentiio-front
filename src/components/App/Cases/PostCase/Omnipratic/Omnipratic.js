...
export default function HorizontalLinearStepper() {
  ...
  const [isLoadEXAM, setIsLoadEXAM] = useState({
    init: exam_pics.length,
    current: 0,
  });
  const [isLoadTREAT, setIsLoadTREAT] = useState({
    init: treat_pics.length,
    current: 0,
  });
      ...
      case "old_injury":
        function addFields() {
          ...
          newDiv.append(
            React.createFactory(
              "TexField",
              <TextField label="Combo box" variant="outlined">
                jj
              </TextField>
            )
          );
  ...
  const handleNext = () => {
    ...
    if (showPatient !== "none") {
      isValidPage = catchErrors("patient");
    }
    if (showDiagnostic !== "none") {
      isValidPage = catchErrors("diagnostic");
    }
    if (showFinalisation !== "none") {
      isValidPage = catchErrors("finalisation");
    }
    ...
    switch (activeStep) {
      ...
      case 3:
        ...
        let intervalID = setInterval(() => {
          if (
            localStorage.getItem("finishloadimgTREAT") !== null &&
            localStorage.getItem("finishloadimgEXAM") !== null
          ) {
            if (
              !/.*[0-9].*/.test(localStorage.getItem("finishloadimgEXAM")) ||
              !/.*[0-9].*/.test(localStorage.getItem("finishloadimgTREAT"))
            ) {
              ...
              // fetch(
              //   `${process.env.REACT_APP_BACK_URL}images/${localStorage.getItem(
              //     "directory"
              //   )}`,
              //   {
              //     method: "GET",
  ...
  function handlePointed(e) {
    if (canvaState) {
      ...
      mergeImages(array_to_merge).then((b64) => {
        dispatch({
          type: action[imgTypeSlider],
          _img: b64,
                ...
                <Grid item xs={10} md={6}>
                  <center>
                    <h1 color={Palette.primary}>
                      VOTRE CAS A ÉTÉ ENREGISTRÉ !
                    </h1>
                    <br></br>
                    <a
                      target="_blank"
                      href="https://docs.google.com/forms/d/e/1FAIpQLSfgi6WlyYhqpOgG46G4iEUeTobpS_52J4mKvCZbSZr-FM0FnA/viewform"
                  ...
                  <Grid item xs={10} md={6}>
                    <div className={classes.paper}>
                      ...
                      <TextField
                        ...
                        fullWidth
                        value={
                          values.gender === undefined ? "M" : values.gender
                        }
                    ...
                    <div className={classes.paper}>
                      ...
                      <TextField
                        ...
                        onKeyDown={(e) =>
                          e.keyCode !== 13 ? null : catchErrors(e)
                        }
                    ...
                    <div className={classes.paper}>
                      ...
                      <DropzoneArea
                        ...
                        Icon={AddAPhotoIcon}
                        dropzoneText={
                          "Ajoutez les images de vos examens cliniques"
                        }
                              ...
                              <Grid container component="main">
                                <Grid item xs={12}>
                                  ...
                                  {imgTypeSlider === TREAT_TYPE ? (
                                    treat_pics && treat_pics[step_slide - 1] ? (
                                      <ArrowBack
                                        color="secondary"
                                        onClick={handleImgBack}
                                      />
